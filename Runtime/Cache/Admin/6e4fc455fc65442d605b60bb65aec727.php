...
<style>
    ...
    <div class="mess">
    	<div>温馨提示：</div>
    	<div>
	    		1. 系统当前只支持xls文件的数据导入。 <a href="/Public/static/customs.xls">下载Excel模板</a><br>
    	...
    	<div>
    		<form action="<?php echo U(Custom/customListImport);?>" method="post" enctype="multipart/form-data">
