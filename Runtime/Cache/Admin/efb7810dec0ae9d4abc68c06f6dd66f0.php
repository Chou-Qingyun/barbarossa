	...
	<div class="cf">
		<div class="fl">
           ...
           <!--  <button class="btn ajax-post" url="<?php echo U('User/changeStatus',array('method'=>'resumeUser'));?>" target-form="ids">启 用</button>
            ...
            <button class="btn ajax-post confirm" url="<?php echo U('Custom/customListDelete');?>" target-form="ids">客户指派</button>
            <button class="btn ajax-post confirm" url="<?php echo U('Custom/customListDelete');?>" target-form="ids">导出Excel</button>
        </div>
