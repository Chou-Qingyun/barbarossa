...
<style>
	...
	<div id="mtitle">	
		<div class="main-title" style="float:left;margin-right:10px;">
			<a href="<?php echo U('Custom/myCustomList');?>"><h2><?php echo get_username();?>的客户</h2></a>
		</div>
		<div class="main-title" style="float:left;margin-right:10px;">
	...
	<div class="cf">
		...
		<div class="search-form fr cf">
			<div class="sleft">
				...
				<a class="sch-btn" href="javascript:;" id="search" url="<?php echo U('Custom/mycustomListSearch');?>"><i class="btn-search"></i></a>
			</div>
		</div>
    </div>
    <!-- 数据列表 -->
    ...
    <tbody>
		<?php if(!empty($_list)): if(is_array($_list)): $i = 0; $__LIST__ = $_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('Custom/customListDetail?id='.$vo['id']);?>"><?php echo ($vo["customer_name"]); ?></td>
    ...
    //导航高亮
    highlight_subnav('<?php echo U('Custom/myCustomList');?>');
