...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表' AUTO_INCREMENT=23 ;
...
(1, 'admin', 'admin', 0, '0000-00-00', '', 1, 0, '', '', '', '', 0, 90, 30, '0', 1445943683, 0, 1448326399, 1),
...
CREATE TABLE IF NOT EXISTS `xmls_my_contact_person` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='联系人表' AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `xmls_my_contract_document` (
  ...
  `status` tinyint(4) NOT NULL COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='合同列表' AUTO_INCREMENT=9 ;
...
CREATE TABLE IF NOT EXISTS `xmls_my_customer_data` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COMMENT='客户资料表' AUTO_INCREMENT=23 ;
...
(8, 'LS15111614194870', '七匹狼', '小七', '男', '市场营销', -39600000, '', '13150623025', '', '', '71859565@qq.com', '', '福建省', '泉州市', '洛江区', '七匹狼大楼', '微信公众号', '正在接触的客户', '服装', 'www.qpl-tmall.com', 1447654769, 1450246773, '七匹狼测试', 'admin', 1446877070, '公共客户', 1448073351, 0, 0),
(21, 'LS15112321504776', '悠家良品', '小悠', '女', '店长', 649350000, '', '15260696523', '', '', 'upstyle@sina.com', 'upstyleshop', '北京市', '市辖区', '东城区', '悠家良品一号店', '百度推广', '进行中的客户', '生活用品', 'www.upstyle-tmall.co', 1448286780, 1450878784, '', 'admin', 1447595447, '公共客户', 0, 0, 0),
(20, 'LS15112316041216', 'haode ', 'haod', '男', '', -115200, '', '15260696523', '', '', 'haode@qq.com', '', '', '', '', '', '百度推广', '进行中的客户', '', '', 0, 0, '', 'admin', 1447229052, '公共客户', 0, 0, 0),
(14, 'LS15112114065847', '古奇天伦', '小轮', '男', '', 0, '26595959', '15260696523', '', '', '1526395@qq.com', '2659585654', '福建', '莆田', '荔城', '职教中心', 'QQ空间', '正在接触中', '', '', 1447545600, 1448064000, '无', 'admin', 1448086018, '公共客户', 0, 0, 0),
(15, 'LS15112114071219', '古奇天伦', '小轮', '男', '', 0, '26595959', '15260696523', '', '', '1526395@qq.com', '2659585654', '福建', '莆田', '荔城', '职教中心', 'QQ空间', '正在接触中', '', '', 1447545600, 1448064000, '无', 'admin', 1448086032, '公共客户', 0, 0, 0),
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='领用表' AUTO_INCREMENT=24 ;
...
(1, 'admin', '753f86cd25d856e511ce1f7f76347d1f', 'admin@admin.com', '', 1445943683, 2130706433, 1448326399, 0, 1445943683, 1),
