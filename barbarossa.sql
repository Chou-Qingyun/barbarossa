...
CREATE TABLE IF NOT EXISTS `xmls_action` (
...
INSERT INTO `xmls_action` (`id`, `name`, `title`, `remark`, `rule`, `log`, `type`, `status`, `update_time`) VALUES
...
--
-- 表的结构 `xmls_action_log`
--

CREATE TABLE IF NOT EXISTS `xmls_action_log` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表' AUTO_INCREMENT=25 ;
...
(16, 1, 1, 0, 'member', 1, 'admin在2015-11-23 08:37登录了后台', 1, 1448239047),
(17, 10, 1, 0, 'Menu', 166, '操作url：/barbarossa/index.php/Admin/Menu/add.html', 1, 1448250373),
(18, 10, 1, 0, 'Menu', 167, '操作url：/barbarossa/index.php/Admin/Menu/add.html', 1, 1448250444),
(19, 10, 1, 0, 'Menu', 168, '操作url：/barbarossa/index.php/Admin/Menu/add.html', 1, 1448250507),
(20, 1, 1, 0, 'member', 1, 'admin在2015-11-23 15:56登录了后台', 1, 1448265397),
(21, 1, 1, 0, 'member', 1, 'admin在2015-11-24 08:53登录了后台', 1, 1448326399),
(22, 10, 1, 0, 'Menu', 169, '操作url：/barbarossa/index.php/Admin/Menu/add.html', 1, 1448344899),
(23, 1, 1, 0, 'member', 1, 'admin在2015-11-25 10:43登录了后台', 1, 1448419435),
(24, 1, 1, 0, 'member', 1, 'admin在2015-11-25 19:37登录了后台', 1, 1448451455);
...
CREATE TABLE IF NOT EXISTS `xmls_addons` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `xmls_addons` (`id`, `name`, `title`, `description`, `status`, `config`, `author`, `version`, `create_time`, `has_adminlist`) VALUES
...
--
-- 表的结构 `xmls_attachment`
--

CREATE TABLE IF NOT EXISTS `xmls_attachment` (
...
CREATE TABLE IF NOT EXISTS `xmls_attribute` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `xmls_attribute`
--

INSERT INTO `xmls_attribute` (`id`, `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES
...
--
-- 表的结构 `xmls_auth_extend`
--

CREATE TABLE IF NOT EXISTS `xmls_auth_extend` (
...
--
-- 转存表中的数据 `xmls_auth_extend`
--

INSERT INTO `xmls_auth_extend` (`group_id`, `extend_id`, `type`) VALUES
(1, 1, 1),
(1, 1, 2),
(1, 2, 1),
(1, 2, 2),
...
--
-- 表的结构 `xmls_auth_group`
--

CREATE TABLE IF NOT EXISTS `xmls_auth_group` (
...
--
-- 表的结构 `xmls_auth_group_access`
--

CREATE TABLE IF NOT EXISTS `xmls_auth_group_access` (
...
--
-- 转存表中的数据 `xmls_auth_group_access`
--
...
CREATE TABLE IF NOT EXISTS `xmls_auth_rule` (
...
(107, 'admin', 1, 'Admin/Action/actionlog', '用户行为日志', 1, ''),
...
(229, 'admin', 1, 'Admin/Custom/customListChangeSource', '批量修改客户来源', 1, ''),
(230, 'admin', 1, 'Admin/System/customPoolSetting', '客户池设置', 1, ''),
(231, 'admin', 1, 'Admin/Custom/excelUpload', '客户资料导入', -1, ''),
(232, 'admin', 1, 'Admin/Custom/shareCustomList', '共享客户列表', 1, ''),
(233, 'admin', 1, 'Admin/Custom/customPoolManage', '公共客户管理', 1, ''),
(234, 'admin', 1, 'Admin/Custom/categoryManage', '客户类别管理', 1, ''),
(235, 'admin', 1, 'Admin/Custom/sourceManage', '客户来源管理', 1, ''),
(236, 'admin', 1, 'Admin/Custom/categoryManageAdd', '客户类别新增', 1, ''),
(237, 'admin', 1, 'Admin/Custom/categoryManageSearch', '客户类别搜索', 1, ''),
...
(267, 'admin', 1, 'Admin/Custom/shareCustomListAction', '共享客户操作页面', 1, ''),
(268, 'admin', 1, 'Admin/Custom/shareCustomListSelf', '我的共享', 1, ''),
(269, 'admin', 1, 'Admin/Custom/shareCustomListSearchTo', '共享给的搜索', 1, ''),
(270, 'admin', 1, 'Admin/Custom/shareCustomListSearchMe', '我的共享的搜索', 1, ''),
(271, 'admin', 1, 'Admin/Custom/customListImport', '客户资料导入', 1, ''),
(272, 'admin', 1, 'Admin/Custom/customListOfone', '批量客户指派', 1, ''),
(273, 'admin', 1, 'Admin/Custom/myCustomContactPersonAdd', '添加联系人', 1, ''),
(274, 'admin', 1, 'Admin/Custom/myCustomContactPersonEdit', '编辑联系人', 1, ''),
(275, 'admin', 1, 'Admin/Custom/myCustomContactPersonCat', '查看联系人', 1, ''),
(276, 'admin', 1, 'Admin/Custom/myCustomDocumentEdit', '编辑合同文档', 1, '');
...
CREATE TABLE IF NOT EXISTS `xmls_category` (
...
INSERT INTO `xmls_category` (`id`, `name`, `title`, `pid`, `sort`, `list_row`, `meta_title`, `keywords`, `description`, `template_index`, `template_lists`, `template_detail`, `template_edit`, `model`, `type`, `link_id`, `allow_publish`, `display`, `reply`, `check`, `reply_model`, `extend`, `create_time`, `update_time`, `status`, `icon`) VALUES
...
CREATE TABLE IF NOT EXISTS `xmls_channel` (
...
--
-- 转存表中的数据 `xmls_channel`
--

INSERT INTO `xmls_channel` (`id`, `pid`, `title`, `url`, `sort`, `create_time`, `update_time`, `status`, `target`) VALUES
...
CREATE TABLE IF NOT EXISTS `xmls_config` (
...
INSERT INTO `xmls_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `status`, `value`, `sort`) VALUES
...
CREATE TABLE IF NOT EXISTS `xmls_document` (
...
--
-- 转存表中的数据 `xmls_document`
--

INSERT INTO `xmls_document` (`id`, `uid`, `name`, `title`, `category_id`, `description`, `root`, `pid`, `model_id`, `type`, `position`, `link_id`, `cover_id`, `display`, `deadline`, `attach`, `view`, `comment`, `extend`, `level`, `create_time`, `update_time`, `status`) VALUES
(1, 1, '', 'OneThink1.0正式版发布', 2, '大家期待的OneThink正式版发布', 0, 0, 2, 2, 0, 0, 0, 1, 0, 0, 8, 0, 0, 0, 1387260660, 1387263112, 1);

-- --------------------------------------------------------

--
-- 表的结构 `xmls_document_article`
--

CREATE TABLE IF NOT EXISTS `xmls_document_article` (
...
--
-- 转存表中的数据 `xmls_document_article`
--

INSERT INTO `xmls_document_article` (`id`, `parse`, `content`, `template`, `bookmark`) VALUES
...
--
-- 表的结构 `xmls_document_download`
--

CREATE TABLE IF NOT EXISTS `xmls_document_download` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文档ID',
  `parse` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '内容解析类型',
...
CREATE TABLE IF NOT EXISTS `xmls_file` (
...
CREATE TABLE IF NOT EXISTS `xmls_hooks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `xmls_hooks` (`id`, `name`, `description`, `type`, `update_time`, `addons`) VALUES
...
(1, 'admin', 'admin', 0, '0000-00-00', '', 1, 0, '', '', '', '', 10, 100, 32, '0', 1445943683, 0, 1448451455, 1),
...
CREATE TABLE IF NOT EXISTS `xmls_menu` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '文档ID',
...
INSERT INTO `xmls_menu` (`id`, `title`, `pid`, `sort`, `url`, `hide`, `tip`, `group`, `is_dev`) VALUES
...
(142, '客户类别搜索', 134, 141, 'Custom/categoryManageSearch', 0, '客户类型搜索的结果', '客户类别管理', 0),
(143, '客户来源搜索结果', 135, 144, 'Custom/sourceManageSearch', 1, '客户来源搜索结果显示', '客户来源管理', 1),
...
(166, '添加联系人', 127, 8, 'Custom/myCustomContactPersonAdd', 0, '添加客户的联系人', '客户资料管理', 0),
(167, '编辑联系人', 127, 9, 'Custom/myCustomContactPersonEdit', 0, '更新客户联系人的资料', '客户资料管理', 0),
(168, '查看联系人', 127, 10, 'Custom/myCustomContactPersonCat', 0, '查看客户联系人资料', '客户资料管理', 0),
(169, '编辑合同文档', 127, 11, 'Custom/myCustomDocumentEdit', 0, '编辑合同文档', '客户资料管理', 0);
...
CREATE TABLE IF NOT EXISTS `xmls_model` (
...
INSERT INTO `xmls_model` (`id`, `name`, `title`, `extend`, `relation`, `need_pk`, `field_sort`, `field_group`, `attribute_list`, `template_list`, `template_add`, `template_edit`, `list_grid`, `list_row`, `search_key`, `search_list`, `create_time`, `update_time`, `status`, `engine_type`) VALUES
...
--
-- 表的结构 `xmls_my_contact_person`
--

CREATE TABLE IF NOT EXISTS `xmls_my_contact_person` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '联系人ID',
  `contact_name` varchar(20) NOT NULL COMMENT '联系人',
  `customer_number` varchar(16) NOT NULL COMMENT '公司编号',
  `customer_name` varchar(30) NOT NULL COMMENT '公司名称',
  `department` varchar(12) NOT NULL COMMENT '部门',
  `position` varchar(12) NOT NULL COMMENT '职位',
  `tel` varchar(12) NOT NULL COMMENT '联系电话',
  `QQ` varchar(15) NOT NULL COMMENT 'QQ',
  `email` varchar(25) NOT NULL COMMENT '邮件',
  `birthday` int(12) NOT NULL COMMENT '出生日期',
  `status` tinyint(4) NOT NULL COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='联系人表' AUTO_INCREMENT=11 ;

--
-- 转存表中的数据 `xmls_my_contact_person`
--

INSERT INTO `xmls_my_contact_person` (`id`, `contact_name`, `customer_number`, `customer_name`, `department`, `position`, `tel`, `QQ`, `email`, `birthday`, `status`) VALUES
(1, '小轮', 'LS15112310560045', '古奇天伦', '', '', '15260696523', 'guqitianlun', 'guqitianlun@qq.com', 0, 0),
(2, '小丽', 'LS15111520002359', '腾讯', '总裁办公室', '总助', '15260696523', '759582856', '759582856@qq.com', 1448259039, 0),
(3, '小丽', 'LS15111520002359', '腾讯', '总裁办公室', '总助', '15260696523', '759582856', '759582856@qq.com', 1448253434, 0),
(4, '小林', 'LS15111520002359', '腾讯', '市场部', '市场营销', '15260696523', '758595856', ' 758595856@qq.com', 1448254137, -1),
(5, 'haod', 'LS15112316041216', 'haode ', '', '', '15260696523', '', 'haode@qq.com', 0, 0),
(6, '小悠', 'LS15112321504776', '悠家良品', '', '店长', '15260696523', 'upstyleshop', 'upstyle@sina.com', 1990, 0),
(7, '小轮', 'LS15112416121944', '古奇天伦', '', '', '15260696523', 'guqitianlun', 'guqitianlun@qq.com', 0, 0),
(8, '小轮', 'LS15112418001294', '古奇天伦', '', '', '15260696523', 'guqitianlun', 'guqitianlun@qq.com', 0, 0),
(9, '小郑', 'LS15111520002359', '腾讯', '财务', '出纳', '15260696523', '', '15260696523@163.com', 1448448138, -1),
(10, '小妞', 'LS15111520002359', '腾讯', '行政', '前台', '15260696523', '', '15260696523@163.com', 1448448231, -1);

-- --------------------------------------------------------

--
-- 表的结构 `xmls_my_contract_document`
--

CREATE TABLE IF NOT EXISTS `xmls_my_contract_document` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '合同ID',
  `customer_number` varchar(16) NOT NULL COMMENT '客户编码',
  `customer_name` varchar(30) NOT NULL COMMENT '客户名称',
  `document_name` varchar(30) NOT NULL COMMENT '文档名称',
  `document_type` varchar(10) NOT NULL COMMENT '文档类别',
  `document_path` text NOT NULL COMMENT '相关附件',
  `document_explain` text NOT NULL COMMENT '文档说明',
  `add_person` varchar(20) NOT NULL COMMENT '添加人',
  `add_time` int(11) NOT NULL COMMENT '添加时间',
  `status` tinyint(4) NOT NULL COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='合同列表' AUTO_INCREMENT=15 ;

--
-- 转存表中的数据 `xmls_my_contract_document`
--

INSERT INTO `xmls_my_contract_document` (`id`, `customer_number`, `customer_name`, `document_name`, `document_type`, `document_path`, `document_explain`, `add_person`, `add_time`, `status`) VALUES
(1, 'LS15111110324050', 'AUMU', '测试的', '合同文档', '/barbarossa/Uploads/Attachment/2015-11-19/1447902216_11.jpg', '测试中', 'admin', 1447902218, 0),
(2, 'LS15111110324050', 'AUMU', '测试的。', '合同文档', '/barbarossa/Uploads/Attachment/2015-11-19/1447902400_12.jpg', '测试的', 'admin', 1447902402, 0),
(3, 'LS15111110324050', 'AUMU', '测试的', '合同文档', '/barbarossa/Uploads/Attachment/2015-11-19/1447902760_12.jpg', '测试', 'admin', 1447902768, 0),
(4, 'LS15111110324050', 'AUMU', '测试的。', '合同文档', '/barbarossa/Uploads/Attachment/2015-11-19/1447911460_2.jpg|/barbarossa/Uploads/Attachment/2015-11-19/1447911463_3.jpg', '', 'admin', 1447911464, -1),
(5, 'LS15112321504776', '悠家良品', '测试的', '其他文档', '|/barbarossa/Uploads/Attachment/2015-11-24/1448343855_server_study.txt', '', 'admin', 1448343857, 0),
(6, 'LS15112321504776', '悠家良品', '测试的', '其他文档', '|/barbarossa/Uploads/Attachment/2015-11-24/1448343925_customs.xls', '', 'admin', 1448343926, 0),
(7, 'LS15112321504776', '悠家良品', '测试的', '合同文档', '|/barbarossa/Uploads/Attachment/2015-11-24/1448343975_admin_151117213617_data.xls|/barbarossa/Uploads/Attachment/2015-11-24/1448343979_admin_20151117171911.xls', '', 'admin', 1448343987, -1),
(8, 'LS15112321504776', '悠家良品', '测试的', '合同文档', '|/barbarossa/Uploads/Attachment/2015-11-24/1448346389_Ð½¨Îı¾Îĵµ.txt', '', 'admin', 1448346399, -1),
(9, 'LS15111520002359', '腾讯', '测试的', '合同文档', '|/barbarossa/Uploads/Attachment/2015-11-24/1448354825_Ð½¨Îı¾Îĵµ.txt', '', 'admin', 1448354832, -1),
(10, 'LS15111520002359', '腾讯', '中文文件名', '合同文档', '|&lt;pre&gt;string(58) &amp;quot;./Attachment/2015-11-24//1448358547_新建文本文档.txt&amp;quot;\r\n&lt;/pre&gt;/barbarossa/Uploads/Attachment/2015-11-24/1448358547_新建文本文档.txt', '', 'admin', 1448358548, -1),
(11, 'LS15111520002359', '腾讯', '中文文件名测试', '合同文档', '|/barbarossa/Uploads/Attachment/2015-11-25/1448436946_customs.xls', '', 'admin', 1448358622, 0),
(12, 'LS15111520002359', '腾讯', '中文文件名测试', '其他文档', '|/barbarossa/Uploads/Attachment/2015-11-25/1448435295_customs.xls', '', 'admin', 1448435296, 0),
(13, 'LS15111110340878', '三只松鼠', '测试TXT', '其他文档', '|/barbarossa/Uploads/Attachment/2015-11-25/1448447359_新建文本文档.txt', '', 'admin', 1448447370, 0),
(14, 'LS15111110340878', '三只松鼠', '阿三', '合同文档', '|/barbarossa/Uploads/Attachment/2015-11-25/1448447440_server_study.txt', '', 'admin', 1448447444, -1);

-- --------------------------------------------------------

--
-- 表的结构 `xmls_my_customer_data`
--

CREATE TABLE IF NOT EXISTS `xmls_my_customer_data` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '客户ID',
  `customer_number` varchar(16) CHARACTER SET utf8 NOT NULL COMMENT '客户编号',
  `customer_name` varchar(30) NOT NULL COMMENT '客户名称',
  `contact_name` varchar(20) NOT NULL COMMENT '联系人',
  `gender` varchar(4) CHARACTER SET utf8 NOT NULL COMMENT '性别',
  ...
  `QQ` varchar(15) CHARACTER SET utf8 NOT NULL COMMENT 'QQ/旺旺',
  `province` varchar(10) CHARACTER SET utf8 NOT NULL COMMENT '省份',
  `city` varchar(10) CHARACTER SET utf8 NOT NULL COMMENT '城市',
  `country` varchar(10) CHARACTER SET utf8 NOT NULL COMMENT '地区',
  `detail_address` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT '详细地址',
  `customer_source` varchar(15) CHARACTER SET utf8 NOT NULL COMMENT '客户来源',
  `customer_type` varchar(10) CHARACTER SET utf8 NOT NULL COMMENT '客户类别',
  `trade` varchar(15) CHARACTER SET utf8 NOT NULL COMMENT '所属行业',
  `website` varchar(20) CHARACTER SET utf8 NOT NULL COMMENT '网页地址',
  `contract_start` int(12) NOT NULL COMMENT '合同始日',
  `contract_end` int(12) NOT NULL COMMENT '合同止日',
  `notes` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '备注',
  `create_people` varchar(10) CHARACTER SET utf8 NOT NULL COMMENT '建档人',
  `create_time` int(11) NOT NULL COMMENT '建档时间',
  `customer_service` varchar(10) CHARACTER SET utf8 NOT NULL COMMENT '客服专员',
  `last_time` int(11) NOT NULL COMMENT '最近一次联系',
  `appoint_time` int(11) NOT NULL COMMENT '预约时间',
  `status` tinyint(2) NOT NULL COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 COMMENT='客户资料表' AUTO_INCREMENT=24 ;
...
(1, 'LS15111519594080', '阿里巴巴', '马路', '男', '助理', -168422400, '0591-12345678', '15260696532', '0591-12345678', '0591-12345678', 'alibaba@sina.com', 'alibabaxiaoma', '北京市', '市辖区', '西城区', '西单一号', 'QQ空间', '正在接触的客户', '电商', 'www.alibaba.com', 1446776061, 1449417600, '测试', 'admin', 1441532477, '公共客户', 1447935462, 1447862400, -1),
(2, 'LS15111520002359', '腾讯', '小马哥', '男', 'CEO', 207590400, '0592-123456', '15263626589', '0592-123456', '0592-12365479', '888888@qq.com', '666666', '天津市', '市辖区', '河西区', '南开小马路1号', 'QQ空间', '正在接触的客户', '互联网社交/游戏/门户/视频', 'www.qq.com', 1446803975, 1451404800, '测试的', 'admin', 1446803988, 'admin', 1447934401, 1448691370, 0),
(3, 'LS15111110340878', '三只松鼠', '小松', '男', '市场营销', 1446220800, '', '2147483647', '', '', '15260696523@163.com', '71859632', '浙江省', '杭州市', '市辖区', '三只松鼠大楼1号', 'QQ空间', '已完成的客户', '电商', 'www.threes.com', 1447038502, 1449590400, '测试的。', '234', 1447038374, 'admin', 1448451262, 1448553600, 0),
(6, 'LS15111110324050', 'AUMU', '小林', '男', '助理', 658598400, '0594-2138526', '2147483647', '0594-2138526', '0594-2138526', 'aumu@hotmail.com', 'aumucustomer', '福建省', '莆田市', '荔城区', '黄石镇', 'QQ空间', '正在接触的客户', '电商，鞋贸', 'www.aumu-tmall.com', 1447209140, 1452528000, '测试的', 'admin', 1447209006, 'admin', 1448450102, 1448035200, 0),
(7, 'LS15111611535892', '七匹狼', '小七', '男', '市场营销', 1971, '0591-2186392', '13152623965', '0591-2186392', '0591-2186392', '1526069632@163.com', 'qpl', '福建省', '泉州市', '洛江区', '七匹狼大楼1号', 'QQ空间', '蠢蠢欲动的客户', '服装', 'qpl.tmall.com', 1447654769, 1450246773, '正在谈', 'admin', 1447654670, 'admin', 1448451221, 0, 0),
(8, 'LS15111614194870', '七匹狼', '小七', '男', '市场营销', -39600000, '', '13150623025', '', '', '71859565@qq.com', '', '福建省', '泉州市', '洛江区', '七匹狼大楼', '微信公众号', '正在接触的客户', '服装', 'www.qpl-tmall.com', 1447654769, 1450246773, '七匹狼测试', 'admin', 1446877070, 'admin', 1448451225, 0, 0),
(23, 'LS15112418001294', '古奇天伦', '小轮', '男', '', 0, '2156369', '15260696523', '', '', 'guqitianlun@qq.com', 'guqitianlun', '福建省', '莆田市', '荔城区', '职教中心', 'QQ空间', '正在接触中', '', '', 1447372800, 1449878400, '无', 'admin', 1448359212, '公共客户', 0, 0, 0),
(21, 'LS15112321504776', '悠家良品', '小悠', '女', '店长', 649350000, '', '15260696523', '', '', 'upstyle@sina.com', 'upstyleshop', '北京市', '市辖区', '东城区', '悠家良品一号店', '百度推广', '进行中的客户', '生活用品', 'www.upstyle-tmall.co', 1448286780, 1450878784, '', 'admin', 1447595447, 'admin', 1448451340, 0, 0),
(20, 'LS15112316041216', 'haode ', 'haod', '男', '', -115200, '', '15260696523', '', '', 'haode@qq.com', '', '', '', '', '', '百度推广', '进行中的客户', '', '', 0, 0, '', 'admin', 1447229052, 'admin', 1448419466, 0, 0),
(14, 'LS15112114065847', '古奇天伦', '小轮', '男', '', 0, '26595959', '15260696523', '', '', '1526395@qq.com', '2659585654', '福建', '莆田', '荔城', '职教中心', 'QQ空间', '正在接触中', '', '', 1447545600, 1448064000, '无', 'admin', 1448086018, 'admin', 1448451295, 0, 0),
(15, 'LS15112114071219', '古奇天伦', '小轮', '男', '', 0, '26595959', '15260696523', '', '', '1526395@qq.com', '2659585654', '福建', '莆田', '荔城', '职教中心', 'QQ空间', '正在接触中', '', '', 1447545600, 1448064000, '无', 'admin', 1448086032, 'admin', 1448419466, 0, 0),
(22, 'LS15112416121944', '古奇天伦', '小轮', '男', '', 0, '2156369', '15260696523', '', '', 'guqitianlun@qq.com', 'guqitianlun', '福建省', '莆田市', '荔城区', '职教中心', 'QQ空间', '正在接触中', '', '', 1447372800, 1449878400, '无', 'admin', 1448352739, '公共客户', 0, 0, 0),
(16, 'LS15112310560045', '古奇天伦', '小轮', '男', '', 0, '2156369', '15260696523', '', '', 'guqitianlun@qq.com', 'guqitianlun', '福建省', '莆田市', '荔城区', '职教中心', 'QQ空间', '正在接触中', '', '', 1447372800, 1449878400, '无', 'admin', 1448247360, 'admin', 1448281224, 1448553600, 0),
(18, '', 'haode ', 'haode', '男', '', 0, '', '15260696523', '', '', '15260696523@163.com', '', '', '', '', '', '百度推广', '进行中的客户', '', '', 0, 0, '', 'admin', 1448265553, 'admin', 0, 0, -1),
(19, 'LS15112316024325', 'haode ', 'haode', '男', '', 0, '', '15260696523', '', '', '15260696523@163.com', '', '', '', '', '', '百度推广', '进行中的客户', '', '', 0, 0, '', 'admin', 1448265763, 'admin', 0, 0, -1);
...
--
-- 表的结构 `xmls_my_customer_receive`
--

CREATE TABLE IF NOT EXISTS `xmls_my_customer_receive` (
  `receive_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '领用表ID',
  `id` int(11) NOT NULL COMMENT '客户ID',
  `customer_name` varchar(30) NOT NULL COMMENT '客户名称',
  `contact_name` varchar(20) NOT NULL COMMENT '联系人',
  `tel` int(12) NOT NULL COMMENT '联系方式',
  `customer_type` varchar(10) NOT NULL COMMENT '客户类型',
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='领用表' AUTO_INCREMENT=41 ;
...
(5, 1, '阿里巴巴', '马路', 2147483647, '正在接触的客户', 'admin', 1446802877, '2015-11-19 09:52:40'),
(6, 1, '阿里巴巴', '马路', 2147483647, '正在接触的客户', 'admin', 1446802877, '2015-11-19 10:52:22'),
(7, 2, '腾讯', '小马哥', 2147483647, '正在接触的客户', 'admin', 1446803988, '2015-11-19 11:15:08'),
(8, 3, '三只松鼠', '小松', 2147483647, '正在接触的客户', '234', 1447038374, '2015-11-19 12:01:19'),
(9, 1, '阿里巴巴', '马路', 2147483647, '正在接触的客户', 'admin', 1441532477, '2015-11-19 12:01:23'),
...
(21, 2, '腾讯', '小马哥', 2147483647, '正在接触的客户', 'admin', 1446803988, '2015-11-23 09:22:19'),
(22, 2, '腾讯', '小马哥', 2147483647, '正在接触的客户', 'admin', 1446803988, '2015-11-24 07:41:32'),
(23, 21, '悠家良品', '小悠', 2147483647, '进行中的客户', 'admin', 1447249847, '2015-11-24 07:49:52'),
(24, 3, '三只松鼠', '小松', 2147483647, '已完成的客户', '234', 1447038374, '2015-11-25 02:44:26'),
(25, 6, 'AUMU', '小林', 2147483647, '正在接触的客户', 'admin', 1447209006, '2015-11-25 02:44:26'),
(26, 7, '七匹狼', '小七', 2147483647, '蠢蠢欲动的客户', 'admin', 1447654670, '2015-11-25 02:44:26'),
(27, 8, '七匹狼', '小七', 2147483647, '正在接触的客户', 'admin', 1446877070, '2015-11-25 02:44:26'),
(28, 21, '悠家良品', '小悠', 2147483647, '进行中的客户', 'admin', 1447595447, '2015-11-25 02:44:26'),
(29, 20, 'haode ', 'haod', 2147483647, '进行中的客户', 'admin', 1447229052, '2015-11-25 02:44:26'),
(30, 14, '古奇天伦', '小轮', 2147483647, '正在接触中', 'admin', 1448086018, '2015-11-25 02:44:26'),
(31, 15, '古奇天伦', '小轮', 2147483647, '正在接触中', 'admin', 1448086032, '2015-11-25 02:44:26'),
(32, 2, '腾讯', '小马哥', 2147483647, '正在接触的客户', 'admin', 1446803988, '2015-11-25 11:09:43'),
(33, 3, '三只松鼠', '小松', 2147483647, '已完成的客户', '234', 1447038374, '2015-11-25 11:09:50'),
(34, 6, 'AUMU', '小林', 2147483647, '正在接触的客户', 'admin', 1447209006, '2015-11-25 11:15:02'),
(35, 7, '七匹狼', '小七', 2147483647, '蠢蠢欲动的客户', 'admin', 1447654670, '2015-11-25 11:33:41'),
(36, 8, '七匹狼', '小七', 2147483647, '正在接触的客户', 'admin', 1446877070, '2015-11-25 11:33:45'),
(37, 2, '腾讯', '小马哥', 2147483647, '正在接触的客户', 'admin', 1446803988, '2015-11-25 11:34:06'),
(38, 3, '三只松鼠', '小松', 2147483647, '已完成的客户', '234', 1447038374, '2015-11-25 11:34:22'),
(39, 14, '古奇天伦', '小轮', 2147483647, '正在接触中', 'admin', 1448086018, '2015-11-25 11:34:55'),
(40, 21, '悠家良品', '小悠', 2147483647, '进行中的客户', 'admin', 1447595447, '2015-11-25 11:35:40');

-- --------------------------------------------------------

--
-- 表的结构 `xmls_my_customer_record`
--

CREATE TABLE IF NOT EXISTS `xmls_my_customer_record` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `customer_number` varchar(16) NOT NULL COMMENT '客户编码',
  `customer_name` varchar(20) NOT NULL COMMENT '客户名称',
  `contact_name` varchar(20) NOT NULL COMMENT '联系人',
  `contact_way` varchar(12) NOT NULL COMMENT '联系方法',
  `txttel` varchar(20) NOT NULL COMMENT '联系方式',
  `contact_content` text NOT NULL COMMENT '联系内容',
  `last_time` int(11) NOT NULL COMMENT '联系时间',
  `contact_type` varchar(12) NOT NULL COMMENT '联系类型',
  `appoint_time` int(11) NOT NULL COMMENT '下次联系/预约时间',
  `next_content` text NOT NULL COMMENT '下次目标',
  `customer_service` varchar(11) NOT NULL COMMENT '联系客服',
  `status` tinyint(4) NOT NULL COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='联系记录表' AUTO_INCREMENT=15 ;
...
(5, 'LS15111520002359', '腾讯', '小马哥', '固定电话', '2147483647', '谈的不错哦。', 1439299039, '客户回访', 1448630256, '下次再聊吧！', 'admin', 0),
(6, 'LS15111110340878', '三只松鼠', '小松', '手机', '2147483647', '投放产品的更新', 1447327309, '客户回访', 1450092184, '销售额达到1千万', '234', 0),
(7, 'LS15111110324050', 'AUMU', '小林', '手机', '15263696523', '双十一销售额突破两千万', 1447334216, '客户来电', 1449590400, '在双十二销售额达到一千万', 'admin', 0),
(8, 'LS15111520002359', '腾讯', '小马哥', '手机', '2147483647', '新产品的投放位置', 1443676605, '客户回访', 1448083480, '好的', 'admin', 0),
(9, 'LS15111520002359', '腾讯', '小马哥', '手机', '2147483647', '嗯。不错的。', 1447934401, '客户来电', 1448691370, '下次再见', 'admin', 0),
...
(13, 'LS15112310560045', '古奇天伦', '小轮', '手机', '15260696523', '好的', 1448281224, '客户回访', 1448553600, '', 'admin', 0),
(14, 'LS15111110340878', '三只松鼠', '小松', '手机', '2147483647', '总得说点什么', 1448445119, '客户来电', 1448553600, '', 'admin', 0);
...
CREATE TABLE IF NOT EXISTS `xmls_my_customer_share` (
  ...
  `status` tinyint(4) NOT NULL COMMENT '状态',
  PRIMARY KEY (`sid`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='客户共享表' AUTO_INCREMENT=19 ;
...
(9, 'haode ', 'haod', '15260696523', '进行中的客户', '百度推广', 'admin', 1448265852, 'admin', 1448266396, '小陈', 'admin', -1),
(10, 'haode ', 'haod', '15260696523', '进行中的客户', '百度推广', 'admin', 1448265852, 'admin', 1448266412, '小陈', 'admin', -1),
(11, '古奇天伦', '小轮', '15260696523', '正在接触中', 'QQ空间', 'admin', 1448247360, 'admin', 1448267005, '小陈', 'admin', 0),
(12, '古奇天伦', '小轮', '15260696523', '正在接触中', 'QQ空间', 'admin', 1448247360, 'admin', 1448267316, '小陈', 'admin', 0),
(13, '古奇天伦', '小轮', '15260696523', '正在接触中', 'QQ空间', 'admin', 1448247360, 'admin', 1448267346, '小陈', 'admin', -1),
(14, 'haode ', 'haod', '15260696523', '进行中的客户', '百度推广', 'admin', 1448265852, 'admin', 1448267636, '小陈', 'admin', 0),
(15, 'haode ', 'haod', '15260696523', '进行中的客户', '百度推广', 'admin', 1448265852, 'admin', 1448267741, '小陈', 'admin', 0),
(16, '古奇天伦', '小轮', '15260696523', '正在接触中', 'QQ空间', 'admin', 1448247360, 'admin', 1448276846, '博思凯', 'admin', 0),
(17, '腾讯', '小马哥', '15263626589', '正在接触的客户', 'QQ空间', 'admin', 1446803988, 'admin', 1448276965, '真实名字', 'admin', -1),
(18, '腾讯', '小马哥', '15263626589', '正在接触的客户', 'QQ空间', 'admin', 1446803988, 'admin', 1448277048, '真实名字', 'admin', 0);

-- --------------------------------------------------------

--
-- 表的结构 `xmls_my_customer_source`
--

CREATE TABLE IF NOT EXISTS `xmls_my_customer_source` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '来源ID',
  `source_name` varchar(50) NOT NULL COMMENT '来源名称',
  `operator` varchar(15) NOT NULL COMMENT '操作人',
  `add_time` int(11) NOT NULL COMMENT '添加时间',
  `is_default` varchar(4) NOT NULL COMMENT '是否默认',
  `status` tinyint(2) NOT NULL COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9 ;

--
-- 转存表中的数据 `xmls_my_customer_source`
--

INSERT INTO `xmls_my_customer_source` (`id`, `source_name`, `operator`, `add_time`, `is_default`, `status`) VALUES
(1, 'QQ空间', '管理员', 1446467746, '否', 0),
(5, '百度推广', 'admin', 1446607535, '是', 0),
(8, '微信公众号', 'admin', 1447202790, '否', 0);

-- --------------------------------------------------------

--
-- 表的结构 `xmls_my_customer_type`
--

CREATE TABLE IF NOT EXISTS `xmls_my_customer_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '类别ID',
  `type_name` varchar(10) NOT NULL COMMENT '类别名称',
  `type_description` varchar(30) NOT NULL COMMENT '类别描述',
  `operator` varchar(15) NOT NULL COMMENT '操作人',
  `create_time` int(11) NOT NULL COMMENT '创建时间',
  `is_default` varchar(4) NOT NULL COMMENT '是否默认',
  `status` tinyint(2) NOT NULL COMMENT '状态',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='客户类别表' AUTO_INCREMENT=22 ;

--
-- 转存表中的数据 `xmls_my_customer_type`
--
...
CREATE TABLE IF NOT EXISTS `xmls_picture` (
...
--
-- 表的结构 `xmls_ucenter_admin`
--

CREATE TABLE IF NOT EXISTS `xmls_ucenter_admin` (
...
--
-- 表的结构 `xmls_ucenter_app`
--

CREATE TABLE IF NOT EXISTS `xmls_ucenter_app` (
...
--
-- 表的结构 `xmls_ucenter_member`
--

CREATE TABLE IF NOT EXISTS `xmls_ucenter_member` (
...
(1, 'admin', '753f86cd25d856e511ce1f7f76347d1f', 'admin@admin.com', '', 1445943683, 2130706433, 1448451455, 0, 1445943683, 1),
...
--
-- 表的结构 `xmls_ucenter_setting`
--

CREATE TABLE IF NOT EXISTS `xmls_ucenter_setting` (
...
CREATE TABLE IF NOT EXISTS `xmls_url` (
...
CREATE TABLE IF NOT EXISTS `xmls_userdata` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户id',
